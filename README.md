...
Проект был создан из-за проблемы в net лимитах буффера gmod, чтобы вынести управлением донатом для донат-менеджеров из игры.
Модуль client можно адаптировать под другие нужды.
